...
import { Home, BookList,AddBook } from './Home';
  ...
  return (
    ...
    {/* Link - change page without refresh/its work is to without refresh change URL, nav - get the correct route*/}
      ...
      <Routes>
        ...
        <Route path="/books" element={<BookList setBookList={setBookList} bookList={bookList} />} />
        <Route path="//books/add-book" element={<AddBook  setBookList={setBookList} bookList={bookList}/>} />
